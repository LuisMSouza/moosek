...
export const description =
  "Para pular para uma música específica na fila do servidor";
...
export const usage = [
  process.env.PREFIX_KEY + "skipto [número da música na fila]",
];
export const category = "user";
export const timeout = 7000;
export const aliases = ["st", "nt", "nextto", "skipto"];
export async function execute(client, message, args) {
  ...
  try {
    await play(client, message, serverQueue.songs[0]);
    message
      .reply({
        embeds: [
          {
            color: "YELLOW",
            description: `⏭ \`${(args[0] || query) - 1}\` músicas puladas por ${
