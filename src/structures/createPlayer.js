...
module.exports.play = async (client, message, song) => {
    const ePlay = client.guilds.cache.get("731542666277290016").emojis.cache.find(emj => emj.name === "4210629");
    const ePause = client.guilds.cache.get("731542666277290016").emojis.cache.find(emj => emj.name === "4210635");
    const eNext = client.guilds.cache.get("731542666277290016").emojis.cache.find(emj => emj.name === "4210646");
    const eBack = client.guilds.cache.get("731542666277290016").emojis.cache.find(emj => emj.name === "4210650");
    const eStop = client.guilds.cache.get("731542666277290016").emojis.cache.find(emj => emj.name === "4210632");
